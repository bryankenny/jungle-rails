...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    @user = User.new(email: "johnsmith@email.com", password: "ABCDEF", password_confirmation: "ABCDEF")
    @user.valid?
    ...
    @user1 = User.new(email: "john@gmail.com", password: "ABCDEF", password_confirmation: "ABCDEF")
    @user1.save
    @user2 = User.new(email: "JOHN@gmail.com", password: "ABCDEF", password_confirmation: "ABCDEF")
    @user2.valid?
    expect(@user2.errors[:email]).to include("has already been taken")
    end

    it 'should not create a User if their passwords do not match' do
    @user = User.new(email: "john@gmail.com", password: "ABCDEF", password_confirmation: "ABCDEFG")
    @user.valid?
    ...
    @user = User.new(email: "john@gmail.com", password: "ABC", password_confirmation: "ABC")
    @user.valid?
  ...
  describe '.authenticate_with_credentials' do
    ...
    it 'should log the user in if the credentials are correct' do
      @user = User.new(email: "johnny123@gmail.com", password: "ABCDEF", password_confirmation: "ABCDEF")
      @user.save!
    ...
    it 'should log the user in even if the email contains spaces' do
      @user = User.new(email: "johnny1234@gmail.com", password: "ABCDEF", password_confirmation: "ABCDEF")
      @user.save!
